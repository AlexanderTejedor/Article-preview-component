            ...
            <section className='bg-white max-w-83 rounded-xl'>
                ...
                <section>
                    <div className='px-10'>
                        ...
                        <p className='text-[13px] text-desaturated-dark-blue'>Ever been in a room and felt like something was missing?
                        Perhaps it felt slightly bare and uninviting. I've got some simple tips to help you make any room feel complete.</p>
                    </div>
                    <div className={`${shared ? 'hidden' : 'flex justify-between items-center mb-5 px-10 mt-7'}`}>
                    ...
                    <div className={`${shared ? 'bg-very-dark-grayish-blue px-10 py-4 flex justify-between items-center rounded-b-lg mt-4' : 'hidden'}`}>
                        ...
                        <div className=' bg-desaturated-dark-blue rounded-full w-9 h-9 flex items-center justify-center'>
                            <i className="ri-share-forward-fill text-white text-xl"></i>
                        </div>
                    </div>
                </section>
            </section>
